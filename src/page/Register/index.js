...
const [loading, setLoading] = useState(false);
 ...
 const PickerDate = () => {
    return (
        ...
        <Image style={{ height: 30, width: 30, bottom:5 }} source={Kalendar} />
...
const handleRegister = () => {
    if ((form.nama.length == 0) || (form.tempat.length == 0)) {
       ...
       showMessage({
          type:'default',
          color:'white',
          message:'Adan Belum Mengisi Tanggal Lahir!',
          backgroundColor:colors.errormessage,
        })
      ...
      showMessage({
          type:'default',
          color:'white',
          message:'Adan Belum Mengisi Tempat Tinggal!',
          backgroundColor:colors.errormessage,
        })
    } else {
      console.log(form);
...
<>
  ...
  <Image style={{height:250, width:250}} source={ApoteKIcon}/>
    ...
    <View style={{padding:10}}> 
     <View><Text style={{textAlign:'center', fontSize:20, fontFamily:'Poppins-SemiBold'}}>- Register</Text></View>
